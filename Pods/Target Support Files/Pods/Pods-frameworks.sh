...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  install_framework 'DATAFilter.framework'
  install_framework 'DATAObjectIDs.framework'
  install_framework 'DATASource.framework'
  install_framework 'DATAStack.framework'
  install_framework 'NSDictionary_ANDYSafeValue.framework'
  install_framework 'NSManagedObject_HYPPropertyMapper.framework'
  install_framework 'NSObject_HYPTesting.framework'
  install_framework 'NSString_HYPNetworking.framework'
  install_framework 'Sync.framework'
fi
